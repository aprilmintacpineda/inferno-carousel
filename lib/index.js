...
var Carousel = function (_Component) {
  ...
  function Carousel(props) {
    ...
    _this.nextItem = function () {
      ...
      _this['carousel-pagination-' + _this.currentItemIndex].classList.remove('active');

      return _this.currentItemIndex + 1;
    };
    ...
    _this.updatePage = function () {
      _this['carousel-pagination-' + _this.currentItemIndex].classList.add('active');
    };
    ...
    _this.switchCurrentItem = function () {
      if (_this.shouldNotAutoPlay) {
        ...
        _this.currentItemIndex = newItemIndex === _this.props.children.length ? 0 : newItemIndex;
        _this.updatePage();
    ...
    _this.playCarousel = function () {
      ...
      var player = function player() {
        if (Date.now() - _this.lastTime >= 1000 * _this.props.loopEvery) {
      ...
      if (!_this.moving && _this.touchDetection.started) {
        ...
        if (100 <= Math.abs(_this.touchDetection.startX - _this.touchDetection.endX)) {
          if (_this.touchDetection.startX > _this.touchDetection.endX) {
            ...
            _this.currentItemIndex = 0 > _newItemIndex ? _this.props.children.length - 1 : _newItemIndex;
    ...
    _this.adjustView = function () {
      if (!_this.carouselItemsList || _this.moving) {
        ...
        _this.scrollTo(_this.currentItemIndex);
      }
    };
    ...
    _this.render = function () {
      ...
      }), (0, _inferno.createVNode)(1, 'div', 'pagination', _this.props.children.map(function (_, i) {
        return (0, _inferno.createVNode)(1, 'span', 'clickable bullet', null, 1, {
          'onClick': function onClick() {
            return _this.scrollTo(i);
          }
        }, i, function (el) {
          _this['carousel-pagination-' + i] = el;
        });
      }), 0)], 4);
    };
